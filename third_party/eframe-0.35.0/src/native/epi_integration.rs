...
impl EpiIntegration {
    ...
    pub fn update(
        ...
        is_visible: bool,
        #[cfg(feature = "slipway_debug")] slipway_debug_notice: Option<
            egui_winit::SlipwayDebugInputNotice,
        >,
    ) -> egui::FullOutput {
        ...
        app.raw_input_hook_with_slipway_debug(
            &self.egui_ctx,
            &mut raw_input,
            slipway_debug_notice.as_ref(),
        );
